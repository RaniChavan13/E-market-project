...
import com.springboot.emarket.service.CustomerService;
...
public class CustomerController {
	...
	@GetMapping("/rest-password/{email}/{token}")
	...
	public String addWishList(@PathVariable int wid, @PathVariable int pid, ModelMap model, HttpSession session) {
